...
let current_users = ["Admin", "Ahtisham", "Hamza", "Husnain", "Usman"]
let new_users = ["Awais", "Sohaib", "Haider", "Ahtisham", "Admin"]

for (let new_user of new_users) {
     let username_taken = current_users.some((current_user) => new_user.toUpperCase() == current_user
     .toUpperCase())

     if (username_taken){
         console.log(`The username "${new_user}" is taken. Please enter a new username.`)
     } else {
